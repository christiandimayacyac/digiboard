...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="card card-body bg-light mt-3">
            ...
            <h2 class="post__header text-center">Edit Post</h2>
            <p>Please enter the post title and post body in this form.</p>
            <form action="<?php echo URLROOT . '/posts/edit/' . $data['post_id']; ?>" class="add_post-form" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="post_body" class="form-control form-control-lg <?php echo (!empty($data['post_body']) ? 'is-invalid' : ''); ?>" rows="5" required><?php echo $data['post_body']; ?></textarea>
                    <span><?php echo (!empty($data['post_body_err']) ? $data['post_body_err'] : '');?></span>
                </div>
                <input type="hidden" name="uid" class="<?php echo (!empty($_SESSION['user_id']) ? 'is-invalid' : ''); ?>" value="<?php echo $_SESSION['user_id']; ?>">
